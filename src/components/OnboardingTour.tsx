...
const tourSteps = [
  {
    ...
    description: 'Monitor your goals with intuitive charts and stay motivated with real-time progress.',
    icon: BarChart,
  ...
  },
  {
    ...
    features: ['Scenario analysis', 'Decision timelines', 'Strategic forecasts']
  },
  {
    title: 'Chat Advisor',
    description: 'Chat with AI for strategic advice tailored to your DISC profile.',
    icon: MessageSquare,
    features: ['Personalized advice', 'DISC-based insights', '24/7 support']
  },
  {
    title: 'Tactical Dashboard',
    description: 'Comprehensive warrior dashboard with rituals and missions for personal transformation.',
    icon: Target,
