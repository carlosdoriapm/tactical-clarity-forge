  ...
  const introSteps = [
    {
      ...
      description: 'Your personalized strategic advisor based on your psychological profile.',
      icon: MessageSquare,
      content: discProfile ?
        `I detected your DISC profile as ${discProfile.primaryType}. I'll tailor my communication to your preferred style.` :
    ...
    },
    {
      ...
      icon: Brain,
      content: discProfile ?
        `As a ${discProfile.primaryType} profile, you respond best to: ${discProfile.communicationStyle}` :
        'Complete your profile to receive deeper insights.'
    },
    {
      ...
      content: userProfile?.mission_90_day ?
        `Your current mission: ${userProfile.mission_90_day}. Let\'s focus on it!` :
        'Define your main mission so we can guide the conversation.'
    }
  ];
